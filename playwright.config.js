...
const frontendUrl = (process.env.E2E_FRONTEND_URL || `http://127.0.0.1:${frontendPort}`).replace(/\/$/, '');
...
module.exports = defineConfig({
  ...
  webServer: !process.env.E2E_FRONTEND_URL ? { command: process.platform === 'win32' ? 'npm.cmd start' : 'npm start', url: frontendUrl, timeout: 120_000, reuseExistingServer: !process.env.CI, env: { PORT: frontendPort, BROWSER: 'none', REACT_APP_API_URL: apiUrl } } : undefined,
